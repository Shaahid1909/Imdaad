//
//  supervisorNotificationView.swift
//  Imdaad_project
//
...
class supervisorNotificationView: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Snotification", for: indexPath) as! supervisorNotifiCell
    ...
    func downloadItems() {
        guard let employeeid = UserDefaults.standard.value(forKey: "employee_id") as? String else {return}
           ...
           let request = NSMutableURLRequest(url: NSURL(string:"https://appstudio.co/iOS/imdaad_supervisor_notification.php")! as URL)
       ...
       func parseJSON(_ data:Data) {
           ...
           for i in 0 ..< jsonResult.count
               ...
               print("datetime \(datetime) \(jsonElement["TaskDate"] as? String) \(datetostring)")
                ...
                notificationdetails.append(Ndetails(wkordertoken: wkordertoken, title: title, message: msg, date_time: datetostring))
