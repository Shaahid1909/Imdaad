//
//  SupervisorReassignWKdetail.swift
//  Imdaad_project
//
...
class SupervisorReassignWKdetail: UIViewController {
    
    
    var det = [Assignwkdetails]()
    ...
    @IBAction func reassignBtnTapped(_ sender: Any) {
    performSegue(withIdentifier: "reassignTap", sender: self)
    }
